...
<input type="text" placeholder="Your title..." class="card__headline">
 ...
 <ul class="card__controls-wrapper">
    <li class="card__controls-item"><button class="card__btn card__btn--arrow" data-value='left'>&#60;</button></li>
    <li class="card__controls-item"><button class="card__btn card__btn--trash"></button></li>
    <li class="card__controls-item"><button class="card__btn card__btn--arrow data-value='right'">&#62;</button></li>
 </ul>
</div>`;
let index;
const moveCardRightFn = (event) => {
  index =
    +event.currentTarget.parentNode.parentNode.parentNode.parentNode.dataset
      .index + 1;
  if (index > document.querySelector(".columns").children.length) index = 1;
  document
